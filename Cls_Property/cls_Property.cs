...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public DataTable GetUsers(string email="",string phoneNo="")
        {
            DataTable dt = new DataTable();
            try
            {
...
public DataTable GetExclusiveListing()
        ...
        public int Insert_Users(string name, string email, string phone)
        {
            int result = 0;
            try
            {
