    ...
    public partial class CreateTestimonial : System.Web.UI.Page
    {
        ...
        protected void btnCreateTestimonial_Click(object sender, EventArgs e)
        {
            ...
            if (updBannerImage.HasFile)
            {
                ...
                fileName = System.IO.Path.GetFileName(updBannerImage.FileName);
                updBannerImage.SaveAs(Server.MapPath("Testimonial") + "\\" + System.IO.Path.GetFileName(updBannerImage.FileName));
