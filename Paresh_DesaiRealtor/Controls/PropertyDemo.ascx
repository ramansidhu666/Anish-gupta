...
<script>
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://www.anishrealty.com/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
                ...
                <div class="propert_top_details">
                    ...
                    <div class="property_top_box_sctn">
                      ...
                      <div class="property_top_box_sctn">
                        ...
                        <div class="row" style="margin-top: 12px; margin-left: -10px; margin-right: -10px;">
