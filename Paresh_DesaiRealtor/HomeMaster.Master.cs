    ...
    public partial class HomeMaster : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li style='background:none;'  class='menuu'><a href='Home_worth.aspx'  title='Home Evaluation'>Free Home Evaluation</a></li>");
                //StrMenu.Append("<li class='menuu'>");
        ...
        public void GetImages()
        {
            ...
            if(dt.Rows.Count>0)
            {
                ...
                {
                    DataTable dt2 = dt.Rows.Cast<DataRow>().CopyToDataTable();
                    if (dt2.Rows.Count > 0)
                    {
        ...
        public void GetTestimonials()
        {
            ...
            DataTable dt = clsobj.GetTestimonial();
            if (dt.Rows.Count > 0)
            {
